    ...
    <div className="bg-white rounded-2xl border border-gray-100 overflow-hidden">
      ...
      <div className="flex flex-col gap-3 p-5 border-b border-gray-100 sm:flex-row sm:items-center sm:justify-between">
        <div>
          ...
          <p className="text-xs text-gray-400 mt-0.5">
            {pagination.total} genre terdaftar
          </p>
        </div>
      ...
      <div className="overflow-x-auto">
        {loading ? (
          ...
          <EmptyState
            message={search ? "Tidak ada genre yang cocok" : "Belum ada genre"}
          />
        ) : (
                ...
                >
                  ...
                  <Td>
                    <div>
                      ...
                      {/* Mobile description */}
                      {genre.deskripsi && (
                        <p className="text-xs text-gray-400 mt-0.5 truncate max-w-[200px] sm:hidden">
                          {genre.deskripsi}
                        </p>
                      )}
                    </div>
